  ...
  <div class="register_page">
    ...
    <div class="form_contianer">
      <div class="titleArea rflex">
        <span class="title" v-text="personRegister" />
      </div>
      <el-form
        ref="registerForm"
        :model="registerForm"
      ...
      >
        ...
        <el-form-item>
          <el-button type="primary" class="submit_btn" @click="submitCompanyRegisterForm">个人注册</el-button>
        </el-form-item>
      </el-form>
    </div>
  </div>
